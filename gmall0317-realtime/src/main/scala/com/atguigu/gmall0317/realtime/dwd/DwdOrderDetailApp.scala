...
import com.atguigu.gmall0317.realtime.util.{MyKafkaSender, MyKafkaUtil, OffsetManager, PhoenixUtil}
  ...
  def main(args: Array[String]): Unit = {
    ...
    val orderDetailWithSkuDstream: DStream[OrderDetail] = orderDetailDstream.mapPartitions { orderDetailItr =>
      ...
      if(orderDetailList.size>0) {
        ...
        val sql = "select id ,tm_id,spu_id,category3_id,tm_name ,spu_name,category3_name  from gmall0317_sku_info  where id in ('" + skuIdList.mkString("','") + "')"
